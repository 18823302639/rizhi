<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"E:\phpStudy\WWW\practice/app/index\view\index\index.html";i:1539573493;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container ">
    <table class="table table-warning text-center ">
        <tr class="active">
            <th><a href="<?php echo url('index/landing'); ?>">请登录/注册</a></th>
            <th >写日志/文章</th>
        </tr>
    </table>
