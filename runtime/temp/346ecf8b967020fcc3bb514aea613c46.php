<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"/var/www/html/www.xiaoxuannhs.xyz/app/index/view/index/landing.html";i:1539588337;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="<?php echo url('index/landing'); ?>" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <a href="<?php echo url('index/register'); ?>">没有账号去注册</a>
                </div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
